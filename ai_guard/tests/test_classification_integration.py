...
class TestAIGuardClientIntegration(unittest.TestCase):
    ...
    def test_classify_with_profile(self):
        ...
        self.server.set_classification_response([
            {"start": 6, "end": 18, "confidence": 100, "text": "321-507-0525", "classifier": "US_PHONE_NUMBER"},
        ])
        ...
        self.assertEqual(resp.context, {"actor": "user", "agent_id": "integration-test", "platform": "AMAZON_BEDROCK"})
